...
VALUES
('2020-10-06', 'LIBERTAD', 'PITBULL, PELAJE COLOR BLANCO, VACUNAS Y BAÑO', 5000),
('2021-12-12', 'NIEVE', 'CANICHE, PELAJE COLOR BLANCO Y NEGRO, CONTROL Y VACUNA', 6000),
('2022-06-16', 'FRANJITA', 'MESTIZO, PELAJE CORTO COLOR NEGRO, CONTROL, VACUNA Y CORTE DE UÑAS', 8250),
('2020-02-26', 'MECHI', 'CHIHUAHUA, PELAJE CORTO COLOR BEIGE, VACUNA Y DESPARACITACION', 7890);
